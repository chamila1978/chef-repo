...
default['aws']['s3']['access_key'] = 'AKIAJGCAQSSS6CKGYHLQ'
default['aws']['s3']['secret_access_key'] = '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'
default['aws']['s3']['bucket'] = 'chamila-jboss7cluster'
