...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "chamila-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/surreytech"
  #   chef.validation_client_name = "surreytech-validator"
  #   chef.validation_key_path = ".chef/surreytech-validator.pem"
  # end
end
